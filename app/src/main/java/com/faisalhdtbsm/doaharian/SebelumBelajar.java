...
public class SebelumBelajar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lafaz = (TextView) findViewById(R.id.sebelajar);
        arti = (TextView) findViewById(R.id.arti_sebelajar);
        sebelajar = lafaz.getText().toString();
        artisebelajar = arti.getText().toString();
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bagikan.putExtra(Intent.EXTRA_TEXT, "" + sebelajar + artisebelajar);
