...
public class SebelumTidur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lafaz = (TextView) findViewById(R.id.sebtidur);
        arti = (TextView) findViewById(R.id.arti_sebtidur);
        sebtidur=lafaz.getText().toString();
        artiSebtidur=arti.getText().toString();
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bagikan.putExtra(Intent.EXTRA_TEXT,""+sebtidur+artiSebtidur);
