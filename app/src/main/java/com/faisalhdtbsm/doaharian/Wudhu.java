...
public class Wudhu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lafaz = (TextView) findViewById(R.id.wudhu);
        arti = (TextView) findViewById(R.id.arti_wudhu);
        wudhu=lafaz.getText().toString();
        artiwudhu=arti.getText().toString();
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bagikan.putExtra(Intent.EXTRA_TEXT,""+wudhu+artiwudhu);
